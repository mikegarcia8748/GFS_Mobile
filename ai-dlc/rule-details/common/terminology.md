...
- Located in `<module_name>/<module_name>-docs/plans/`
- Examples: `story-generation-plan.md`, `unit-of-work-plan.md`

### Artifacts
Generated outputs from executing plans.
- Located in various `<module_name>/<module_name>-docs/` subdirectories
- Examples: `requirements.md`, `stories.md`, `design.md`

### State Files
Files tracking workflow progress and status.
- `<module_name>/<module_name>-docs/aidlc-state.md`: Overall workflow state
- `<module_name>/<module_name>-docs/audit.md`: Complete audit trail of all interactions

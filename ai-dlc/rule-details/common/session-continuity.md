...
Based on your `<module_name>/<module_name>-docs/aidlc-state.md`, here's your current status:
...
1. **Always read `<module_name>/<module_name>-docs/aidlc-state.md` first** when detecting existing project
...
7. **Log the continuity prompt** in `<module_name>/<module_name>-docs/audit.md` with timestamp

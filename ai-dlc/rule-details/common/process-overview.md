...
• **Per-Module Planning**: All planning documents and tracking files for a given module are stored inside its dedicated `<module_name>-docs/` folder. The rules do not use a global `aidlc-docs` folder.

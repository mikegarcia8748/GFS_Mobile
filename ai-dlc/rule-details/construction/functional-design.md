...
- Read unit definition from `<module_name>/<module_name>-docs/inception/application-design/unit-of-work.md`
- Read assigned stories from `<module_name>/<module_name>-docs/inception/application-design/unit-of-work-story-map.md`
...
### Step 4: Store Plan
- Save as `<module_name>/<module_name>-docs/construction/plans/{unit-name}-functional-design-plan.md`
...
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/business-logic-model.md`
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/business-rules.md`
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/domain-entities.md`
- If unit includes frontend/UI: Create `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/frontend-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the functional design artifacts at: `<module_name>/<module_name>-docs/construction/[unit-name]/functional-design/`
...
- Mark Functional Design stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`

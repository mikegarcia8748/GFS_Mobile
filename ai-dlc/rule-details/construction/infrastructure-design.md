...
- Read functional design from `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/`
- Read NFR design from `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `<module_name>/<module_name>-docs/construction/plans/{unit-name}-infrastructure-design-plan.md`
...
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/infrastructure-design/infrastructure-design.md`
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `<module_name>/<module_name>-docs/construction/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `<module_name>/<module_name>-docs/construction/[unit-name]/infrastructure-design/`
...
- Mark Infrastructure Design stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`

...
- Read NFR requirements from `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `<module_name>/<module_name>-docs/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-design/nfr-design-patterns.md`
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `<module_name>/<module_name>-docs/construction/[unit-name]/nfr-design/`
...
- Mark NFR Design stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`

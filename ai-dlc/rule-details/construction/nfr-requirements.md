...
- Read functional design artifacts from `<module_name>/<module_name>-docs/construction/{unit-name}/functional-design/`
...
### Step 4: Store Plan
- Save as `<module_name>/<module_name>-docs/construction/plans/{unit-name}-nfr-requirements-plan.md`
...
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-requirements/nfr-requirements.md`
- Create `<module_name>/<module_name>-docs/construction/{unit-name}/nfr-requirements/tech-stack-decisions.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR requirements at: `<module_name>/<module_name>-docs/construction/[unit-name]/nfr-requirements/`
...
- Mark NFR Requirements stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`

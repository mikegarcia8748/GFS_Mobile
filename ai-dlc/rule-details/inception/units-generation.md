...
- [ ] Generate `<module_name>/<module_name>-docs/inception/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `<module_name>/<module_name>-docs/inception/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `<module_name>/<module_name>-docs/inception/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `<module_name>/<module_name>-docs/inception/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in <module_name>/<module_name>-docs/inception/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
- DO NOT PROCEED until user confirms

## Step 10: Log Approval
- Log prompt and response in <module_name>/<module_name>-docs/audit.md with timestamp
- Use ISO 8601 timestamp format
- Include complete approval prompt text

## Step 11: Update Progress
- Mark Units Planning complete in <module_name>/<module_name>-docs/aidlc-state.md
...
- [ ] Read the complete plan from `<module_name>/<module_name>-docs/inception/plans/unit-of-work-plan.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `<module_name>/<module_name>-docs/inception/application-design/`
...
- Mark Units Generation stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`
- Update the "Current Status" section

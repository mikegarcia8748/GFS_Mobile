...
Create `<module_name>/<module_name>-docs/inception/plans/execution-plan.md`:
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the execution plan at: `<module_name>/<module_name>-docs/inception/plans/execution-plan.md`
...
Log in `<module_name>/<module_name>-docs/audit.md`:

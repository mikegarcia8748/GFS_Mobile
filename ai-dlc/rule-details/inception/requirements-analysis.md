...
- Load `<module_name>/<module_name>-docs/inception/reverse-engineering/architecture.md`
- Load `<module_name>/<module_name>-docs/inception/reverse-engineering/component-inventory.md`
- Load `<module_name>/<module_name>-docs/inception/reverse-engineering/technology-stack.md`
...
1. Record each extension's enablement status in `<module_name>/<module_name>-docs/aidlc-state.md` under `## Extension Configuration`:
...
### Step 6: Generate Clarifying Questions (PROACTIVE APPROACH)
   - **ALWAYS** create `<module_name>/<module_name>-docs/inception/requirements/requirement-verification-questions.md` unless requirements are exceptionally clear and complete
...
### Step 7: Generate Requirements Document
   ...
   - Create `<module_name>/<module_name>-docs/inception/requirements/requirements.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the requirements document at: `<module_name>/<module_name>-docs/inception/requirements/requirements.md`
...
**Note**: Include the "Add User Stories" option only when User Stories stage will be skipped. Replace [User Stories/Workflow Planning] with the actual next stage name.
   ...
   - Update Requirements Analysis stage complete in `<module_name>/<module_name>-docs/aidlc-state.md`
...
Check if `<module_name>/<module_name>-docs/aidlc-state.md` exists for the target module:
...
- Identify workspace root directory (NOT `<module_name>-docs/`)
...
- Check for existing reverse engineering artifacts in `<module_name>/<module_name>-docs/inception/reverse-engineering/`
...
Create `<module_name>/<module_name>-docs/aidlc-state.md`:
...
## Code Location Rules
- **Application Code**: Inside module directories (NEVER in <module_name>-docs/)
- **Documentation**: <module_name>-docs/ only
- **Structure patterns**: Per-module documentation allocation

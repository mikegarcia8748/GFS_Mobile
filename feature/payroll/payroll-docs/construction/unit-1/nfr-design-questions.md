# NFR Design Clarification Questions: Unit 1 (Attendance Migration)

Please answer the following questions to help refine the non-functional design patterns and components for Unit 1.
...
[Answer]: A, and disable settings clear cache/clear data function, if user intended redirect to app instead.

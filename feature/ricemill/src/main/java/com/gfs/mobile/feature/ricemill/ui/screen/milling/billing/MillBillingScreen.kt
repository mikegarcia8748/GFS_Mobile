...
private fun CustomerSelect(
    ...
    Column(
        ...
        if (customerList.isEmpty()) {
            ...
            val composition by rememberLottieComposition(spec = LottieCompositionSpec.RawRes(com.gfs.mobile.core.ui.R.raw.anim_searching))
